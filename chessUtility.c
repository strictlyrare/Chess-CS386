...
bool putsOutOfCheck( ChessBoardType **board, char currentType, int initialRow, int initialCol, int currentRow, int currentCol, char currentTurn, bool initialPawn )
   ...
   if( !isInCheck( checkedBoard, currentTurn, INCHECK ) && currentRow != initialRow && currentCol != initialCol && checkIfValidPosition( checkedBoard, currentType, currentTurn, initialRow, initialCol, currentRow, currentCol, &currentState, initialPawn ) )
      {
